...
if ( ! function_exists( 'some_like_it_neat_sanitize_checkbox' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_multiple_checkbox' ) ) {
	 ...
	 *
	 * This sanitization function can be used with some_like_it_neat_Customize_Multiple_Checkbox_Control.
	 *
	 * @since      1.0.0
	 * @param      string    $values    Coma-delineated string values.
	 * @return     array                Array of sanitized values.
	 */
	function some_like_it_neat_sanitize_multiple_checkbox( $values ) {
		if ( ! is_array( $values ) ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_select' ) ) {
	 ...
	 *                                                The setting default.
	 */
	function some_like_it_neat_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_url' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_url( $url ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_email' ) ) {
	 ...
	 *                                                The setting default.
	 */
	function some_like_it_neat_sanitize_email( $email, $setting ) {
		// Sanitize $email
...
if ( ! function_exists( 'some_like_it_neat_sanitize_image' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_image( $image, $setting ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_hex_color' ) ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_dropdown_pages' ) ) {
	 ...
	 *                                                the setting default.
	 */
	function some_like_it_neat_sanitize_dropdown_pages( $page_id, $setting ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_number_range' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_number_absint' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_number_absint( $number, $setting ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_css' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_css( $css ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_html' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_html( $html ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_nohtml' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_nohtml( $nohtml ) {
...
if ( ! function_exists( 'some_like_it_neat_sanitize_null' ) ) {
	 ...
	 */
	function some_like_it_neat_sanitize_null( $null ) {
		return null;
	}
